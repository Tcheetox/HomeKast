...
namespace Cast.SharedModels.User
{
    public class UserProfile
    {
        ...
        public void Update(List<string>? extensions = null, List<string>? directories = null)
        {
            _settings.Library = new LibrarySettings
            {
                Directories = directories ?? Library.Directories,
                Extensions = extensions ?? Library.Extensions
            };
